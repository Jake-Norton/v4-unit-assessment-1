...
function trueOrFalse (data) {
  if (data===false || data===null || data===undefined || data==='' || data===0 || data===NaN){
    return false
  } else {
    return true
  }
...
let me = {
  ...
  state: 'Utah',
  age: 20,
  greeter: function (firstName, state, age) {
...
let secondFunctionScope = ['global', 'outer', 'functional']
